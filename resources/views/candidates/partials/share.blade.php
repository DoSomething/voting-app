<ul class="social-links">
    ...
    <li><a class="social-icon -twitter js-share-link"
           href="{{ tweet_intent(setting('twitter_language'), (isset($candidate) ? route('candidates.show', [$candidate->slug]) : 'CANDIDATE_LINK'), (isset($candidate) ? $candidate->share_name : null)) }}"><span>Twitter</span></a>
    </li>
</ul>
