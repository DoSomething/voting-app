...
@section('content')
    ...
    <div class="wrapper">
        ...
        <div class="form-actions">
            <a href="{{ route('winner-categories.destroy', [$category->slug]) }}" data-method="DELETE" data-confirm="Are you sure you want to delete this category?" class="button -danger">Delete Category</a>
        </div>
    </div>
@stop
