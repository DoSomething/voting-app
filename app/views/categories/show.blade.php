...
@section('content')
  ...
  <div class="wrapper -narrow">
    ...
    <p>If you know a celeb who's done kick ass things in the world, but don't see them on our list, let us know by emailing {{ link_to('mailto:writein@celebsgonegood.com', 'writein@celebsgonegood.com') }}. Thanks!</p>
  </div>
