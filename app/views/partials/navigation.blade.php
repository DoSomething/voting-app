<nav class="primary">
  ...
  @else
    <p class="navigation__tagline">Vote for your favorite celeb who has done kick ass things in the world. Vote once per day in each category, and don't forget voting ends December 24th!</p>
  @endif
